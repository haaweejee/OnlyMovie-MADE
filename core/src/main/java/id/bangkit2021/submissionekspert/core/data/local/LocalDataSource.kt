...
class LocalDataSource(private val movieDao: id.bangkit2021.submissionekspert.core.data.local.room.MovieDao) {
    ...
    suspend fun insertMovie(movieEntity: List<id.bangkit2021.submissionekspert.core.data.local.entity.MovieEntity>) =
        movieDao.insertMovies(movieEntity)

    fun setFavoriteMovie(
        movieEntity: id.bangkit2021.submissionekspert.core.data.local.entity.MovieEntity,
        favorite: Boolean
    ) {
